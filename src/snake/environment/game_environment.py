...
class SnakeEnv(gym.Env):
    def __init__(self):
        ...
        self.observation_space = MultiDiscrete([4] * 10 * 10) # {0: 'Nothing', 1: 'food', 2: 'tail', 3: 'head'}
    ...
    def render(self, mode='human'):
        ...
        if mode == 'human':
            ...
            plt.pause(0.025)  # Adjust for visualization speed
    ...
    def visualize_game_state(self, state):
        ...
        for i in range(10):
            for j in range(10):
                self.ax.text(j, i, int(grid[i, j]), color="black", ha='center', va='center', fontsize=10)
    ...
    def _update_state(self, action: Discrete(3)) -> (bool, MultiDiscrete([4] * 10 * 10), bool):
        """
